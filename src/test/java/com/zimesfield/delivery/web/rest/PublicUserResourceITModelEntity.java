...
@IntegrationTest
class PublicUserResourceITModelEntity {
    ...
    public void initTest() {
        userModel = UserEntityModelResourceIT.initTestUser(em);
    }
    ...
    void getAllPublicUsers() throws Exception {
        ...
        restUserMockMvc
            ...
            .andExpect(jsonPath("$.[?(@.id == '%s')].login", userModel.getId()).value(userModel.getLogin()))
            .andExpect(jsonPath("$.[?(@.id == '%s')].keys()", userModel.getId()).value(Set.of("id", "login")))
